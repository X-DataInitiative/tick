...
# -*- coding: utf-8 -*-
#
# CMAP team SIMPAS documentation build configuration file, created by
# sphinx-quickstart on Mon Jun 29 11:10:36 2015.
#
...
sys.path.insert(0, os.path.abspath('/Users/martin/Projects/X/tick'))
...
project = 'tick'
copyright = '2015, Emmanuel Bacry, Martin Bompaire, Stephane Gaiffas, ' \
...
htmlhelp_basename = 'CMAPteamSIMPASdoc'
...
latex_documents = [
  (master_doc, 'CMAPteamSIMPAS.tex', 'CMAP team SIMPAS Documentation',
   'Emmanuel Bacry, Martin Bompaire, Stephane Gaiffas, Maryan Morel, '
   'Søren Poulsen', 'manual'),
]
...
man_pages = [
    (master_doc, 'cmapteamsimpas', 'tick Documentation',
     [author], 1)
]
