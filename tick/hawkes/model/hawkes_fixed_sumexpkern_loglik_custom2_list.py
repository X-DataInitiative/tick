...
from .build.model import ModelHawkesFixedSumExpKernCustomType2LogLikList as \
    _ModelHawkesFixedSumExpKernCustomType2LogLikList


class ModelHawkesFixedSumExpKernCustomType2LogLikList(ModelFirstOrder):
    ...
    def __init__(self, decays: np.ndarray, MaxN : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedSumExpKernCustomType2LogLikList(decays, MaxN, n_threads)
        print(self._model)
