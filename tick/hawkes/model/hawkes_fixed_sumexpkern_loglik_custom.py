...
from tick.hawkes.model.build.model import ModelHawkesSumExpCustom as _ModelHawkesSumExpCustom

class ModelHawkesSumExpCustom(ModelFirstOrder):
    ...
    def __init__(self, decays: np.ndarray, MaxN_of_f : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesSumExpCustom(decays, MaxN_of_f, n_threads)
        print(self._model)
