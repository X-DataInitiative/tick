...
from .build.model import ModelHawkesFixedSumExpKernCustom3LogLikList as _ModelHawkesFixedSumExpKernCustom3LogLikList


class ModelHawkesFixedSumExpKernCustom3LogLikList(ModelFirstOrder):
    ...
    def __init__(self, decays: np.ndarray, MaxN : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedSumExpKernCustom3LogLikList(decays, MaxN, n_threads)
        print(self._model)
