...
from .build.model import ModelHawkesFixedSumExpKernLeastSqQRH2List as \
    _ModelHawkesFixedSumExpKernLeastSqQRH2List


class ModelHawkesFixedSumExpKernLeastSqQRH2List(ModelFirstOrder):
    ...
    def __init__(self, decays: np.ndarray, MaxN : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedSumExpKernLeastSqQRH2List(decays, MaxN, n_threads)
        print(self._model)
