...
from .build.model import ModelCustomBasicLogLikList as \
    _ModelCustomBasicLogLikList


class ModelCustomBasicLogLikList(ModelFirstOrder):
    ...
    def __init__(self, decay : float, MaxN_of_f : int, n_threads: int = 1):
        ...
        self._model = _ModelCustomBasicLogLikList(decay, MaxN_of_f, n_threads)
        print(self._model)
