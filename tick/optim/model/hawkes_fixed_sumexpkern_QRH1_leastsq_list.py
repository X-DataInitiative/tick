...
from .build.model import ModelHawkesFixedSumExpKernLeastSqQRH1List as \
    _ModelHawkesFixedSumExpKernLeastSqQRH1List


class ModelHawkesFixedSumExpKernLeastSqQRH1List(ModelFirstOrder):
    ...
    def __init__(self, decays: np.ndarray, MaxN : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedSumExpKernLeastSqQRH1List(decays, MaxN, n_threads)
        print(self._model)
