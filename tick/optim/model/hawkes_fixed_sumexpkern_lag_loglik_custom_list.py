...
from .build.model import ModelHawkesFixedSumExpKernLagCustomLogLikList as \
    _ModelHawkesFixedSumExpKernLagCustomLogLikList


class ModelHawkesFixedSumExpKernLagCustomLogLikList(ModelFirstOrder):
    ...
    def __init__(self, decays: 'ArrayDouble const &', lags: 'ArrayDouble const &', _MaxN_of_f: 'ulong const',
                 max_n_threads: 'int const' = 1):
        ModelFirstOrder.__init__(self)
        self._model = _ModelHawkesFixedSumExpKernLagCustomLogLikList(decays, lags, _MaxN_of_f, max_n_threads)
        print(self._model)
