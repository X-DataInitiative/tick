...
%{
#include "variants/hawkes_fixed_sumexpkern_lag_custom_loglik_list.h"
%}

%shared_ptr(ModelHawkesFixedSumExpKernLagCustomLogLikList);


class ModelHawkesFixedSumExpKernLagCustomLogLikList : public ModelHawkesCustomLogLikList {

public:

    ModelHawkesFixedSumExpKernLagCustomLogLikList(const ArrayDouble &decays, const ArrayDouble &lags,
            const ulong _MaxN_of_f, const int max_n_threads = 1);
