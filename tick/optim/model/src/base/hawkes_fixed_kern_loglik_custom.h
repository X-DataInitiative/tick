//
// Created by pwu on 11/15/17.
//

#ifndef TICK_HAWKES_FIXED_KERN_LOGLIK_CUSTOM_H
#define TICK_HAWKES_FIXED_KERN_LOGLIK_CUSTOM_H
...
//class ModelHawkesFixedKernCustomList;

/**
 * \class ModelHawkesFixedKernCustom
 ...
 * decay)
 */
class DLL_PUBLIC ModelHawkesFixedKernCustom : public ModelHawkesSingle {
protected:
...
//    friend ModelHawkesFixedKernCustomList;
};
