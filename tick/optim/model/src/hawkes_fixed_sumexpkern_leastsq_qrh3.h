#ifndef TICK_OPTIM_MODEL_SRC_HAWKES_FIXED_SUMEXPKERN_LEASTSQ_QRH3_H_
#define TICK_OPTIM_MODEL_SRC_HAWKES_FIXED_SUMEXPKERN_LEASTSQ_QRH3_H_
...
/** \class ModelHawkesFixedSumExpKernLeastSqQRH3
 ...
 * with fixed beta)
 */
class DLL_PUBLIC ModelHawkesFixedSumExpKernLeastSqQRH3 : public ModelHawkesSingle {
...
ModelHawkesFixedSumExpKernLeastSqQRH3() {}
...
ModelHawkesFixedSumExpKernLeastSqQRH3(const ArrayDouble &decays,
                                      const ulong MaxN,
...
//! you know what it is
ulong inline get_alpha_u_i_j_index(const ulong u, const ulong i, const ulong j) const{
//    return n_nodes + u * n_nodes * n_nodes + i * n_nodes + j;
    //the old format
    return n_nodes + i * n_decays * n_nodes + j * n_decays + u;
    //the new format
}

friend class ModelHawkesFixedSumExpKernLeastSqQRH3List;

};

//CEREAL_REGISTER_TYPE(ModelHawkesFixedSumExpKernLeastSqQRH3);

#endif  // TICK_OPTIM_MODEL_SRC_HAWKES_FIXED_SUMEXPKERN_LEASTSQ_QRH3_H_
