 ...
 * decay)
 */
class DLL_PUBLIC ModelHawkesCustomType2 : public ModelHawkesFixedKernLogLik {
public:
...
public:
    ...
    ModelHawkesCustomType2() : ModelHawkesFixedKernLogLik(0), decay(0) {}
...
private:
    ...
    ulong get_alpha_i_last_index(const ulong i) const override {
        return n_nodes * MaxN + (i + 1) * n_nodes;
    }
