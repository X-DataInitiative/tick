...
ModelHawkesSumExpCustom::ModelHawkesSumExpCustom(const double _decay, const ulong _MaxN_of_f, const int max_n_threads) :
        ModelHawkesFixedSumExpKernCustom(_MaxN_of_f, max_n_threads),
        decay(_decay) {}
