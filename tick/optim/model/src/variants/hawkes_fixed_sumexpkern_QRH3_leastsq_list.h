#ifndef TICK_OPTIM_MODEL_SRC_VARIANTS_HAWKES_QRH3_LEASTSQ_LIST_H_
#define TICK_OPTIM_MODEL_SRC_VARIANTS_HAWKES_QRH3_LEASTSQ_LIST_H_
...
class DLL_PUBLIC ModelHawkesFixedSumExpKernLeastSqQRH3List : public ModelHawkesList {
    ...
    std::vector<std::unique_ptr<ModelHawkesFixedSumExpKernLeastSqQRH3> > model_list;
...
public:
    ...
    explicit ModelHawkesFixedSumExpKernLeastSqQRH3List(const int max_n_threads = 1);

    ModelHawkesFixedSumExpKernLeastSqQRH3List(const ModelHawkesFixedSumExpKernLeastSqQRH3List& model) = delete;
    ModelHawkesFixedSumExpKernLeastSqQRH3List& operator=(const ModelHawkesFixedSumExpKernLeastSqQRH3List& model) = delete;
...
protected:
    virtual std::unique_ptr<ModelHawkesFixedSumExpKernLeastSqQRH3> build_model(const int n_threads) {
        return std::unique_ptr<ModelHawkesFixedSumExpKernLeastSqQRH3>(
                new ModelHawkesFixedSumExpKernLeastSqQRH3(decays, MaxN, n_threads, 0));
...
#endif  // TICK_OPTIM_MODEL_SRC_VARIANTS_HAWKES_QRH3_LEASTSQ_LIST_H_
