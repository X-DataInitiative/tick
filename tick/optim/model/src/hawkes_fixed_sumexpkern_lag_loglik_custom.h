#ifndef TICK_OPTIM_MODEL_SRC_CUSTOM_SUMEXP_LAG
#define TICK_OPTIM_MODEL_SRC_CUSTOM_SUMEXP_LAG
 ...
 * decay)
 */
class DLL_PUBLIC ModelHawkesSumExpCustomLag : public ModelHawkesFixedKernLogLik {
public:
...
public:
     ...
     */
    ModelHawkesSumExpCustomLag(const ArrayDouble _decays, const ArrayDouble _lags, const ulong _MaxN_of_f, const int max_n_threads = 1);
...
#endif  // TICK_OPTIM_MODEL_SRC_CUSTOM_SUMEXP_LAG