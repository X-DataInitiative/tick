...
from .build.model import ModelHawkesFixedExpKernCustomType2LogLikList as \
    _ModelHawkesFixedExpKernCustomType2LogLikList


class ModelHawkesFixedExpKernCustomType2LogLikList(ModelFirstOrder):
    ...
    def __init__(self, decay : float, MaxN: int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedExpKernCustomType2LogLikList(decay, MaxN, n_threads)
        print(self._model)
