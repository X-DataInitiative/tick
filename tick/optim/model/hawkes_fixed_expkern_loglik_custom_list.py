...
from .build.model import ModelHawkesFixedExpKernCustomLogLikList as \
    _ModelHawkesFixedExpKernCustomLogLikList


class ModelHawkesFixedExpKernCustomLogLikList(ModelFirstOrder):
    ...
    def __init__(self, decay : float, MaxN_of_f : int, n_threads: int = 1):
        ...
        self._model = _ModelHawkesFixedExpKernCustomLogLikList(decay, MaxN_of_f, n_threads)
        print(self._model)
