...
class SAGA(SolverFirstOrderSto):
    ...
    prox-capable. Note that :class:`SAGA <tick.optim.solver.SAGA>` works only
    ...
    One iteration of :class:`SAGA <tick.optim.solver.SAGA>` corresponds to the
    ...
    Internally, :class:`SAGA <tick.optim.solver.SAGA>` has dedicated code when
