...
from ..build.simulation import HawkesKernelExpLag as _HawkesKernelExpLag


class HawkesKernelExpLag(HawkesKernel):
    ...
    """
    def __init__(self, intensity, decay, lag):
        HawkesKernel.__init__(self)
        self._kernel = _HawkesKernelExpLag(intensity, decay, lag)
