...
from .build.simulation import Hawkes as _Hawkes, Hawkes_custom as _HawkesCustom, Hawkes_customType2 as _Hawkes_customType2
from .build.simulation import Hawkes_QRH3 as _Hawkes_QRH3
    ...
    def __init__(self, kernels=None, baseline=None, n_nodes=None,
        ...
        if custom == 'Type3':
            if extrainfo is not None:
                self._pp = _Hawkes_QRH3(n_nodes, self._pp_init_seed, MaxN_of_f, f_i, extrainfo, simu_mode)
            else:
                self._pp = _Hawkes_QRH3(n_nodes, self._pp_init_seed, MaxN_of_f, f_i)
        elif custom == 'Type2':
            if extrainfo is not None:
