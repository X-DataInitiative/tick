...
##################################################################################################################
from tick.optim.model.hawkes_fixed_sumexpkern_QRH3_leastsq_list import ModelHawkesFixedSumExpKernLeastSqQRH3List

model_list = ModelHawkesFixedSumExpKernLeastSqQRH3List(betas, MaxN_of_f, n_threads=-1)
...
print(model_list.loss(x_real)) #x_real is simulated for QRH2(code QRH1)
