...
#ifndef TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_LAG_H_
#define TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_LAG_H_
 ...
 * the description of lag to be added
 */
class HawkesKernelExpLag : public HawkesKernel {
 ...
 public :
   ...
   */
  HawkesKernelExpLag(const HawkesKernelExpLag &kernel);
  ...
  std::shared_ptr<HawkesKernel> duplicate_if_necessary(const std::shared_ptr<HawkesKernel> &kernel) override {
    return std::make_shared<HawkesKernelExpLag>(*this);
  }
...
#endif  // TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_LAG_H_
