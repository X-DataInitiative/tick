...
#ifndef TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_SUM_EXP_LAG_H_
#define TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_SUM_EXP_LAG_H_
...
class HawkesKernelSumExpLag : public HawkesKernel {
  ...
  ArrayULong convolution_restart_indexs;
 ...
 public :
   ...
   */
  explicit HawkesKernelSumExpLag(const ArrayDouble &intensities, const ArrayDouble &decays, ArrayDouble lags);
   ...
   */
  HawkesKernelSumExpLag(const HawkesKernelSumExpLag &kernel);
  ...
  override {
    return std::make_shared<HawkesKernelSumExpLag>(*this);
  }
...
#endif  // TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_SUM_EXP_LAG_H_
