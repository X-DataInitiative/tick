...
Poisson::Poisson(SArrayDoublePtr intensities,
                 int seed) : PP(static_cast<unsigned int>(intensities->size()), seed) {
...
bool Poisson::update_time_shift_(double delay, ArrayDouble &intensity, double *total_intensity_bound) {
    return false;
}
