#ifndef TICK_BASE_SRC_PARALLEL_PARALLEL_STDTHREAD_H_
#define TICK_BASE_SRC_PARALLEL_PARALLEL_STDTHREAD_H_
...
#endif  // TICK_BASE_SRC_PARALLEL_PARALLEL_STDTHREAD_H_
