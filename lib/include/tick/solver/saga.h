...
class DLL_PUBLIC TBaseSAGA : public TStoSolver<T, K> {
 ...
 public:
  ...
  TBaseSAGA(ulong epoch_size, T tol, RandType rand_type, T step, size_t record_every = 1,
...
class DLL_PUBLIC TSAGA : public TBaseSAGA<T, K, T> {
 ...
 public:
  ...
  TSAGA(ulong epoch_size, T tol, RandType rand_type, T step, size_t record_every = 1, int seed = -1, int n_threads = 1);
...
class DLL_PUBLIC AtomicSAGA : public TBaseSAGA<T, K, std::atomic<T>> {
 ...
 public:
  ...
  AtomicSAGA(ulong epoch_size, T tol, RandType rand_type, T step, size_t record_every = 1,
...
class DLL_PUBLIC ExtraAtomicSAGA : public TBaseSAGA<T, std::atomic<T>, std::atomic<T>> {
 ...
 public:
  ...
  ExtraAtomicSAGA(ulong epoch_size, T tol, RandType rand_type, T step, size_t record_every = 1,
                   int seed = -1, int n_threads = 2);
