#ifndef LIB_INCLUDE_TICK_OPTIM_PROX_PROX_EQUALITY_H_
#define LIB_INCLUDE_TICK_OPTIM_PROX_PROX_EQUALITY_H_
...
#endif  // LIB_INCLUDE_TICK_OPTIM_PROX_PROX_EQUALITY_H_
