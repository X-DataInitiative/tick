...
#ifndef LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_LIST_H_
#define LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_LIST_H_
...
#endif  // LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_LIST_H_
