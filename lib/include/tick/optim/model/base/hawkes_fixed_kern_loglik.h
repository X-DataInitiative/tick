...
#ifndef LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_FIXED_KERN_LOGLIK_H_
#define LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_FIXED_KERN_LOGLIK_H_
...
#endif  // LIB_INCLUDE_TICK_OPTIM_MODEL_BASE_HAWKES_FIXED_KERN_LOGLIK_H_
