...
//
#ifndef LIB_INCLUDE_TICK_OPTIM_MODEL_MODEL_GENERALIZED_LINEAR_H_
#define LIB_INCLUDE_TICK_OPTIM_MODEL_MODEL_GENERALIZED_LINEAR_H_
...
#endif  // LIB_INCLUDE_TICK_OPTIM_MODEL_MODEL_GENERALIZED_LINEAR_H_
