...
#ifndef LIB_INCLUDE_TICK_OPTIM_MODEL_HAWKES_FIXED_EXPKERN_LOGLIK_H_
#define LIB_INCLUDE_TICK_OPTIM_MODEL_HAWKES_FIXED_EXPKERN_LOGLIK_H_
...
#endif  // LIB_INCLUDE_TICK_OPTIM_MODEL_HAWKES_FIXED_EXPKERN_LOGLIK_H_
