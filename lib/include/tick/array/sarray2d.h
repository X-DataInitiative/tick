...
SARRAY2D_DEFINE_TYPE_BASIC(int32_t, Int);
SARRAY2D_DEFINE_TYPE_BASIC(uint32_t, UInt);
SARRAY2D_DEFINE_TYPE_BASIC(int16_t, Short);
SARRAY2D_DEFINE_TYPE_BASIC(uint16_t, UShort);
SARRAY2D_DEFINE_TYPE_BASIC(int64_t, Long);
SARRAY2D_DEFINE_TYPE_BASIC(ulong, ULong);
