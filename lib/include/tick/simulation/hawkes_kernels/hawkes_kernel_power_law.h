...
#ifndef LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_POWER_LAW_H_
#define LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_POWER_LAW_H_
...
#endif  // LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_POWER_LAW_H_
