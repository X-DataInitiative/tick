...
#ifndef LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
#define LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
...
#endif  // LIB_INCLUDE_TICK_SIMULATION_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
