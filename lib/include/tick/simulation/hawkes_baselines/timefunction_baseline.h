...
#ifndef LIB_INCLUDE_TICK_SIMULATION_HAWKES_BASELINES_TIMEFUNCTION_BASELINE_H_
#define LIB_INCLUDE_TICK_SIMULATION_HAWKES_BASELINES_TIMEFUNCTION_BASELINE_H_
...
#endif  // LIB_INCLUDE_TICK_SIMULATION_HAWKES_BASELINES_TIMEFUNCTION_BASELINE_H_
