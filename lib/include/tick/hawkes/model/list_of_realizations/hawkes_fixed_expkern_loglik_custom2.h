#ifndef TICK_OPTIM_MODEL_SRC_CUSTOM_VER2
#define TICK_OPTIM_MODEL_SRC_CUSTOM_VER2
 ...
 * decay)
 */
class DLL_PUBLIC ModelHawkesCustomType2 : public ModelHawkesLogLikSingle {
 protected:
 ...
 public:
  ...
  ModelHawkesCustomType2() : ModelHawkesLogLikSingle(0), decay(0) {}
 ...
 private:
  ...
  ulong get_alpha_i_first_index(const ulong i) const { return n_nodes * MaxN + i * n_nodes; }

  /**
   * @brief Return the end of alpha i coefficients in a coeffs vector
   * @param i : selected dimension
   */
  ulong get_alpha_i_last_index(const ulong i) const { return n_nodes * MaxN + (i + 1) * n_nodes; }

 public:
  ulong get_n_coeffs() const { return n_nodes * MaxN + n_nodes * n_nodes; }
...
#endif  // TICK_OPTIM_MODEL_SRC_CUSTOM_VER2
