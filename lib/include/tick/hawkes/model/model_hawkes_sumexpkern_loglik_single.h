 ...
 * processes with sum exponential kernels with fixed exponent (i.e., \f$ \sum_u
 * \alpha_u \beta_u e^{-\beta_u t} \f$, with fixed decays)
 */
class DLL_PUBLIC ModelHawkesSumExpKernLogLikSingle
