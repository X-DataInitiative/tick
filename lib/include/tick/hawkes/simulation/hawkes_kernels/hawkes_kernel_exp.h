...
#ifndef TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
#define TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
...
#endif  // TICK_SIMULATION_SRC_HAWKES_KERNELS_HAWKES_KERNEL_EXP_H_
