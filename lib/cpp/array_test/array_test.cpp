...
#define TEST_LAST_CPP(ARRAY_TYPE) \
  double test_last_##ARRAY_TYPE(ARRAY_TYPE &array) { return array.last(); }
...
TEST_NEW_PTR_CPP(SparseArrayDouble2d, SSparseArrayDouble2d,
...
SArrayDoublePtrList1D test_slice_view1d(ArrayDouble &a, ulong start,
  ...
  ArrayDouble end_start_slice_view =
      view(start_slice_view, 0, start_slice_view.size() - end);
  ArrayDouble end_end_slice_view =
      view(end_slice_view, 0, end_slice_view.size() - end);
...
TEST_AS_ARRAY_PTR_CPP(SparseArrayDouble, SSparseArrayDoublePtr,
                      as_ssparsearray_ptr);

TEST_AS_ARRAY_PTR_CPP(ArrayDouble2d, SArrayDouble2dPtr, as_sarray2d_ptr);

TEST_AS_ARRAY_PTR_CPP(SparseArrayDouble2d, SSparseArrayDouble2dPtr,
                      as_ssparsearray2d_ptr);

#define TEST_SUM_CPP(ARRAY_TYPE) \
  double test_sum_##ARRAY_TYPE(ARRAY_TYPE &array) { return array.sum(); }
...
#define TEST_MIN_CPP(ARRAY_TYPE) \
  double test_min_##ARRAY_TYPE(ARRAY_TYPE &array) { return array.min(); }
...
#define TEST_MAX_CPP(ARRAY_TYPE) \
  double test_max_##ARRAY_TYPE(ARRAY_TYPE &array) { return array.max(); }
...
void test_mult_add_mult_incr_ArrayDouble(ArrayDouble &array, BaseArrayDouble &x,
                                         double a, BaseArrayDouble &y,
                                         double b) {
