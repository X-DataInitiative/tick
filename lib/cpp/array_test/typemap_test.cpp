...
ARRAY_TYPEMAP_CPP(double, ArrayDouble, ArrayDouble2d, ArrayDoubleList1D,
                  ...
                  SArrayDouble, SArrayDouble2d, SArrayDoublePtr,
                  SArrayDouble2dPtr, SArrayDoublePtrList1D,
                  SArrayDoublePtrList2D, SArrayDouble2dPtrList1D,
                  SArrayDouble2dPtrList2D, VArrayDouble, VArrayDoublePtr,
                  VArrayDoublePtrList1D, VArrayDoublePtrList2D, BaseArrayDouble,
                  BaseArrayDouble2d, SSparseArrayDouble, SSparseArrayDoublePtr,
                  SSparseArrayDouble2d, SSparseArrayDouble2dPtr,
                  SBaseArrayDouble2dPtr, SBaseArrayDoublePtr,
...
ARRAY_TYPEMAP_CPP(std::int32_t, ArrayInt, ArrayInt2d, ArrayIntList1D,
                  ArrayIntList2D, SparseArrayInt, SparseArrayInt2d, SArrayInt,
                  SArrayInt2d, SArrayIntPtr, SArrayInt2dPtr, SArrayIntPtrList1D,
                  SArrayIntPtrList2D, SArrayInt2dPtrList1D,
                  SArrayInt2dPtrList2D, VArrayInt, VArrayIntPtr,
...
ARRAY_TYPEMAP_CPP(std::int16_t, ArrayShort, ArrayShort2d, ArrayShortList1D,
                  ...
                  SSparseArrayShortPtr, SSparseArrayShort2d,
                  SSparseArrayShort2dPtr, SBaseArrayShort2dPtr,
                  SBaseArrayShortPtr, BaseArrayShortList1D,
...
ARRAY_TYPEMAP_CPP(std::uint16_t, ArrayUShort, ArrayUShort2d, ArrayUShortList1D,
                  ArrayUShortList2D, SparseArrayUShort, SparseArrayUShort2d,
                  SArrayUShort, SArrayUShort2d, SArrayUShortPtr,
                  SArrayUShort2dPtr, SArrayUShortPtrList1D,
                  SArrayUShortPtrList2D, SArrayUShort2dPtrList1D,
                  SArrayUShort2dPtrList2D, VArrayUShort, VArrayUShortPtr,
                  VArrayUShortPtrList1D, VArrayUShortPtrList2D, BaseArrayUShort,
                  BaseArrayUShort2d, SSparseArrayUShort, SSparseArrayUShortPtr,
                  SSparseArrayUShort2d, SSparseArrayUShort2dPtr,
                  SBaseArrayUShort2dPtr, SBaseArrayUShortPtr,
...
ARRAY_TYPEMAP_CPP(std::int64_t, ArrayLong, ArrayLong2d, ArrayLongList1D,
                  ArrayLongList2D, SparseArrayLong, SparseArrayLong2d,
                  SArrayLong, SArrayLong2d, SArrayLongPtr, SArrayLong2dPtr,
                  SArrayLongPtrList1D, SArrayLongPtrList2D,
                  ...
                  SSparseArrayLongPtr, SSparseArrayLong2d,
...
ARRAY_TYPEMAP_CPP(std::uint64_t, ArrayULong, ArrayULong2d, ArrayULongList1D,
                  ...
                  SSparseArrayULongPtr, SSparseArrayULong2d,
                  SSparseArrayULong2dPtr, SBaseArrayULong2dPtr,
                  SBaseArrayULongPtr, BaseArrayULongList1D,
...
ARRAY_TYPEMAP_CPP(std::uint32_t, ArrayUInt, ArrayUInt2d, ArrayUIntList1D,
                  ArrayUIntList2D, SparseArrayUInt, SparseArrayUInt2d,
                  SArrayUInt, SArrayUInt2d, SArrayUIntPtr, SArrayUInt2dPtr,
                  SArrayUIntPtrList1D, SArrayUIntPtrList2D,
                  ...
                  SSparseArrayUIntPtr, SSparseArrayUInt2d,
...
ARRAY_TYPEMAP_CPP(float, ArrayFloat, ArrayFloat2d, ArrayFloatList1D,
                  ...
                  SSparseArrayFloatPtr, SSparseArrayFloat2d,
                  SSparseArrayFloat2dPtr, SBaseArrayFloat2dPtr,
                  SBaseArrayFloatPtr, BaseArrayFloatList1D,
