...
cat appveyor/pip/numpy/numpy-1.15.0+mkl-cp37* > appveyor/pip/numpy-1.15.0+mkl-cp37-cp37m-win_amd64.whl
/c/Python37-x64/Scripts/pip install appveyor/pip/numpy-1.15.0+mkl-cp37-cp37m-win_amd64.whl
/c/Python37-x64/Scripts/pip install appveyor/pip/numpydoc-0.7.0-py2.py3-none-any.whl
/c/Python37-x64/Scripts/pip install appveyor/pip/scipy-1.1.0-cp37-cp37m-win_amd64.whl
