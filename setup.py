...
model_core_info = {
    "cpp_files": ["model_labels_features.cpp",
          ...
          "hawkes_fixed_sumexpkern_loglik_custom3.cpp",
		  "modelcustombasic.cpp",
		  "model_rsb.cpp",
          "hawkes_fixed_sumexpkern_leastsq_qrh1.cpp",
          "hawkes_fixed_sumexpkern_leastsq_qrh2.cpp",
          "hawkes_fixed_sumexpkern_leastsq_qrh3.cpp",
    ...
    "h_files": ["model.h",
        ...
        "hawkes_fixed_sumexpkern_loglik_custom3.h",
        "hawkes_fixed_sumexpkern_leastsq_qrh1.h",
        "hawkes_fixed_sumexpkern_leastsq_qrh2.h",
        "hawkes_fixed_sumexpkern_leastsq_qrh3.h",
		"modelcustombasic.h",
		"model_rsb.h",
